    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 rounded-lg border p-6 shadow-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">{t('twoFactorDesc')}</p>
        </div>
        ...
        <form onSubmit={handleVerify} className="mt-8 space-y-6">
          <div className="space-y-4">
            <div>
              <label htmlFor="code" className="block text-sm font-medium">
                {isUsingBackupCode ? t('backupCode') : t('verifyCode')}
              </label>
              <input
                id="code"
                name="code"
                ...
                placeholder={isUsingBackupCode ? t('backupCodePlaceholder') : t('verifyCodePlaceholder')}
          ...
          <div className="flex flex-col space-y-4">
            ...
            >
              {loading ? t('loading', { ns: 'Common' }) : t('confirm', { ns: 'Common' })}
            </button>
            ...
            >
              {isUsingBackupCode ? t('useVerificationCode') : t('useBackupCode')}
            </button>
          </div>
        </form>
      </div>
