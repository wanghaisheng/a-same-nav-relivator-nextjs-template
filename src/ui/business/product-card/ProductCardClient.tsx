...
import { Card, CardContent, CardFooter } from "~/ui/components/core/card";
...
export const ProductCardClient: React.FC<ProductCardProps> = ({ product, variant = "default", onAddToCart, onAddToWishlist, className, ...props }) => {
